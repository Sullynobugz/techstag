...
const PRODUCTS = [
  {
    ...
    desc: 'Ersetzt CRM, Pipeline-Tools, Finanz-Dashboards und externe Berater durch eine einzige Plattform mit KI-Advisor. Für KMU mit eigenem Sales-Team.',
    status: 'active',
    flagship: true,
  ...
  },
  {
    id: 'spare',
    name: 'Spare',
    tagline: 'Freizeit-Spar-Abo',
    desc: '10–15€/Monat → 4 Tokens → einlösbar bei lokalen Freizeitanbietern: Kino, Bowling, Wellness, Restaurants. Gegenwert übersteigt den Abo-Preis.',
    status: 'active',
    tags: ['Lifestyle', 'Abo', 'Mobile'],
  },
  {
    id: 'quest',
    name: 'Quest',
    tagline: 'Gamifiziertes Habit-Tracking',
    desc: 'Gewohnheiten und To-Dos werden zu Quests. XP sammeln, Levels aufsteigen, Streaks aufbauen, Achievements freischalten. Anti-Cheat inklusive.',
    status: 'active',
    tags: ['Productivity', 'Gamification', 'Mobile'],
  },
  {
    id: 'guesswho',
    name: 'GuessWho',
    tagline: 'KI-Ratespiel für Partys',
    desc: 'Digitales "Wer bin ich?". Claude AI spielt die Charaktere und beantwortet Ja/Nein-Fragen in Echtzeit. Multiplayer via WebSockets.',
    status: 'active',
  ...
  },
  {
    id: 'letterz',
    name: 'Letterz',
    tagline: 'Buchstaben-Partyspiel',
    desc: 'Spieler wählen reihum Buchstaben und nennen Wörter passend zur Kategorie. Zwei Modi: Punkte oder KO. Deutsch & Englisch, für 2+ Spieler.',
    status: 'active',
    tags: ['Game', 'Party', 'Mobile'],
  },
  {
    id: 'learn2play',
    name: 'Learn2Play',
    tagline: 'Lernen schaltet Spielzeit frei',
    desc: 'Edutainment für Kinder (6–12 Jahre). Lerneinheit abschließen → Spielzeit-Token verdienen → Minigames spielen. Eltern konfigurieren Fächer und Schwierigkeit.',
    status: 'paused',
    tags: ['EdTech', 'Kids', 'Gamification'],
  },
]
