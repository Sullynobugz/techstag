    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <Logo size="sm" className="text-primary-400" />
              <span className="text-xl font-bold">TechStag</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Navigate the AI forest with expert guidance. We transform businesses 
              through strategic AI solutions that cut through complexity.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2024 TechStag. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
